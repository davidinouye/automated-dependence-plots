"""Edited for our purposes from sklearn.inspection._partial_dependence from sklearn 0.22"""
"""Mainly added a quick hacks for my_get_partial_dependence"""
...
from sklearn_utils_new import _safe_indexing
from sklearn_utils_new import _determine_key_type
from sklearn_utils_new import _get_column_indices # Copied function as needed from new sklearn
...
def _partial_dependence_brute(est, grid, features, X, response_method):
    ...
    for new_values in grid:
        ...
        #print ('averaged_predictions', averaged_predictions)
...
def partial_dependence(estimator, X, features, response_method='auto',
    ...
    #print (averaged_predictions, averaged_predictions.shape)
    #print (values)
    #print (*[val.shape[0] for val in values])
    #print([val.shape[0] for val in values])
...
'''
Leqi: Get Partial Dependence
'''
def my_get_partial_dependence(estimator, X, features, feature_names=None,
                            target=None, response_method='auto', n_cols=3,
                            grid_resolution=100, percentiles=(0.05, 0.95),
                            method='auto', n_jobs=None, verbose=0, fig=None,
                            line_kw=None, contour_kw=None, ax=None):
